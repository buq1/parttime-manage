<template>
  <div class="home">
    ...
    <div class="bottom">
      ...
      <div style="margin-top: 10px" class="bottom-title">
        <span>入驻企业情况</span>
      </div>
      <div class="bottom-list">
        <div class="bottom-item">
...
.odd-bar {
  ...
  border-radius: 5px;
  color: rgb(116, 190, 140);
  font-weight: bolder;
}
.even-bar {
  font-size: 3rem;
  color: rgb(67, 101, 220);
}
.odd-bar-other {
  font-size: 2rem;
  line-height: 3rem;
